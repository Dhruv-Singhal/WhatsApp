...
import com.example.dhruv.whatsapp.R.drawable.came
...
class BlankFragment2() : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        rvcoursesa.layoutManager= GridLayoutManager(activity,1, RecyclerView.VERTICAL,false)



        rvcoursesa.adapter = CourseAdapter(courses)
